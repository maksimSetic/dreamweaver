      ...
      >
        ...
        {!loading && notes.length === 0 && (
          <div className="bg-gradient-to-r from-purple-800/30 to-blue-800/30 border border-purple-500/30 rounded-xl p-12 text-center">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">No cosmic notes yet</h3>
          ...
          {notes.length > 0 && (
            <thead className="bg-gradient-to-r from-purple-700/50 to-blue-700/50">
              <tr className="text-left">
                <th className="px-6 py-4 text-purple-100 font-semibold">Title</th>
                <th className="px-6 py-4 text-purple-100 font-semibold">Description</th>
                <th className="px-6 py-4 text-purple-100 font-semibold">Status</th>
                <th className="px-6 py-4 text-purple-100 font-semibold">CreatedAt</th>
                <th className="px-6 py-4 text-purple-100 font-semibold">UpdatedAt</th>
                <th className="px-6 py-4 text-purple-100 font-semibold text-right">Actions</th>
              </tr>
            </thead>
          )}
      ...
      <AnimatePresence>
        {modalOpen && (
          ...
          >
            ...
            >
              ...
              >
                <div>
                  <label className="text-sm text-purple-200 ml-2 block mb-2">✨ Title</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="text-sm text-purple-200 ml-2 block mb-2">🎯 Status</label>
                  <select
        ...
        {toDeleteId && (
          ...
          >
            ...
            >
              <div className="text-lg font-semibold mb-3 text-white">🗑️ Are you sure?</div>
              <div className="text-sm text-red-200 mb-4">
                This action will permanently delete the note and cannot be undone.
              </div>
